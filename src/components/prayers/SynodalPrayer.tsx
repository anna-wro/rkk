...
export const SynodalPrayer = () => {
  return (
    <div className="mt-5 space-y-2">
      <p>
        <b>Duchu Święty,</b> wołamy do Ciebie jako Twój Kościół, który gromadzi
        się na Synodzie.
      </p>
      <p>
        Jesteśmy jak naczynia gotowe do wypełnienia żywą wodą. Ulecz nasze
        spękania, oczyść nasze wnętrza, aby woda, którą nam dajesz, nie uległa
        zanieczyszczeniu, ale abyś przez nas poił wszystkich spragnionych
        Ciebie.
      </p>
      <p>
