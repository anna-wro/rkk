...
<Canticle
  order={1}
  sigla="Psalm 50"
  antiphon="Składaj Bogu ofarę dziękczynną, * wypełnij swe śluby wobec Najwyższego."
  versicles={[
...
albo pił krew kozłów?`,
    `Składaj Bogu ofarę dziękczynną, *
...
abym was nie porwał, i nikt was nie ocali.`,
    `Kto składa ofarę dziękczynną, ten cześć Mi oddaje, *
...
Pan brzydzi się człowiekiem podstępnym i krwawym.`,
    `Ja zaś dzięki obftości Twojej łaski *
