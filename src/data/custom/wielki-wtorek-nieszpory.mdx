...
<Canticle
  order={3}
  sigla="Psalm 97"
  antiphon="Panie, cierpię przemoc: * Ty się ujmij za mną, / bo nie wiem, 
co mam odpowiedzieć wrogom."
  versicles={[
...
<>{`Wszechmogący, wieczny Boże, † daj nam tak sprawować misteria Męki Pańskiej, * abyśmy mogli otrzymać Twoje przebaczenie. Przez naszego Pana Jezusa Chrystusa, Twojego Syna, † który z Tobą żyje i króluje we wspólnocie Ducha Świętego, * Bóg, przez wszystkie wieki wieków. Amen.`}</>
