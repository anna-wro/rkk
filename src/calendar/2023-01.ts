...
export const January2023: CalendarType = [
  {
    date: '2023-01-01',
    week: 1,
    season: 'christmas',
  ...
  },
  {
    ...
    season: 'christmas',
    holidays: ['OKTAWA EPIFANII'],
    passages: ['1 J 4, 11-18', 'Ps 72', 'Mk 6, 45-52'],
    lauds: {
      sigla: '1 J 1, 5',
      passage:
  ...
  },
  {
    ...
    week: 2,
    season: 'christmas',
    passages: ['Hbr 4, 12-16', 'Ps 19', 'Mk 2, 13-17'],
  ...
  },
  {
    ...
    season: 'christmas',
    passages: ['Iz 49, 3, 5-6', 'Ps 40', '1 Kor 1, 1-3', 'J 1, 29-34'],
  ...
  },
  {
    ...
    week: 1,
    season: 'christmas',
    passages: ['Hbr 5, 1-10', 'Ps 110', 'Mk 2, 18-22'],
  },
  {
    date: '2023-01-17',
    week: 1,
    season: 'christmas',
    passages: ['Hbr 6, 10-20', 'Ps 111', 'Mk 2, 23-28'],
    notes: ['[HTML]Antoniego[HTML] mn.', '[HTML]Pachomiusza[HTML] mn.'],
  },
  {
    date: '2023-01-18',
    week: 1,
    season: 'christmas',
    passages: ['Iz 52, 7-10', 'Ps 23', 'Mt 16, 13-19'],
    holidays: ['WYZNANIE ŚWIĘTEGO PIOTRA'],
    notes: ['Rozpoczyna się Tydzień modlitw o jedność chrześcijan'],
  },
  {
    date: '2023-01-19',
    week: 1,
    season: 'christmas',
    passages: ['Hbr 7, 25-8, 6', 'Ps 40', 'Mk 3, 7-12'],
  },
  {
    date: '2023-01-20',
    week: 1,
    ...
    notes: ['[HTML]Sebastiana[HTML] m.', 'Dzień wspólnego postu'],
  },
  {
    date: '2023-01-21',
    week: 1,
    season: 'christmas',
    passages: ['Hbr 9, 2-3, 11-14', 'Ps 47', 'Mk 3, 20-21'],
  },
  {
    date: '2023-01-22',
    week: 2,
    ...
    passages: ['Iz 8, 23b-9, 3', 'Ps 27', '1 Kor 1, 10-13, 17', 'Mt 4, 12-23'],
  },
  {
    date: '2023-01-23',
    week: 2,
    season: 'christmas',
    passages: ['Hbr 9, 15, 24-28', 'Ps 98', 'Mk 3, 22-30'],
  },
  {
    date: '2023-01-24',
    week: 2,
    season: 'christmas',
    passages: ['Hbr 10, 1-10', 'Ps 40', 'Mk 3, 31-35'],
  },
  {
    date: '2023-01-25',
    week: 2,
    season: 'christmas',
    passages: ['Dz 22, 3-16', 'Ps 117', 'Mk 16, 15-18'],
    holidays: ['NAWRÓCENIE ŚWIĘTEGO PAWŁA'],
    notes: ['Kończy się Tydzień modlitw o jedność chrześcijan'],
  },
  {
    date: '2023-01-26',
    week: 2,
    season: 'christmas',
    passages: ['Hbr 10, 19-25', 'Ps 24', 'Mk 4, 21-25'],
    notes: ['[HTML]Tymoteusza[HTML] bp', '[HTML]Tytusa[HTML] bp'],
  },
  {
    date: '2023-01-27',
    week: 2,
    season: 'christmas',
    passages: ['Hbr 10, 32-39', 'Ps 37', 'Mk 4, 26-34'],
  ...
  },
  {
    ...
    week: 1,
    season: 'christmas',
    passages: ['So 2, 3; 3, 12-13', 'Ps 146', '1 Kor 1, 26-31', 'Mt 5, 1-12a'],
