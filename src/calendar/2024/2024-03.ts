...
export const March2024: CalendarType = [
  {
    date: '2024-03-01',
    week: 2,
    season: 'lent',
  ...
  },
  {
    ...
    week: 2,
    season: 'pascha',
    holidays: ['WIELKA SOBOTA', 'WIGILIA PASCHALNA'],
    notes: [
      '[HTML]Jana Klimaka[HTML] mn.',
      'Tego dnia sprawuje się wyłącznie Liturgię Godzin. Po zmroku rozpoczyna się Wigilia Paschalna',
    ],
    passages: ['Czytania wg lekcjonarza Tom 2 str. 101 – 117'],
