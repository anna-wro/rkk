...
export const September2023: CalendarType = [
  ...
  },
  {
    ...
    passages: ['Mi 5, 1-4a', 'albo' 'Rz 8, 28-30', 'Ps 13', 'Mt 1, 1-16.18-23'], //nie wiem jak zrobić albo :D
    links: [
      {
        name: 'jutrznia',
  ...
  },
  {
    ...
    notes: ['[HTML]Hildegardy z Bingen[HTML] mn. i mis.', 'Święto patronalne wspólnoty w Łodzi'],
  },
  {
    date: '2022-09-18',
    week: 2,
